...
public class EmailService {
    ...
    public void sendBookingConfirmationEmail(String recipientEmail, String name, BookingResponse booking) {
        try {
            ...
            String formattedDateTime = DATE_TIME_FORMATTER_TUNIS.format(booking.getSlotStart());
                        ...
                        <div class="content">
                            ...
                            <div class="details">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Client Email:</strong> %s</li>
                                    <li><strong>Client Phone:</strong> %s</li>
    ...
    public void sendBusinessFeedbackEmail(String businessEmail, String businessName, Feedback feedback, BookingResponse booking) {
        try {
            ...
            String clientInfo = feedback.getIsAnonymous() ? "Anonymous" : 
                (booking.getClientName() != null ? booking.getClientName() : "Unknown") + " (" + 
                (booking.getClientEmail() != null ? booking.getClientEmail() : "Unknown") + ")";
    ...
    @Async
    public void sendBookingCancellationEmail(String recipientEmail, String name, BookingResponse booking) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");

            helper.setTo(recipientEmail);
            helper.setSubject("Booking Cancellation - " + booking.getBusinessName());
            helper.setFrom("yahyaaahamdi8756@gmail.com"); // Replace with your sender email
            ...
            String htmlContent = """
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            <p>Dear <strong>%s</strong>,</p>
                            <p>Your booking with <strong>%s</strong> has been successfully cancelled. Below are the details of the cancelled appointment:</p>
                            <div class="details">
    ...
    @Async
    public void sendBusinessBookingCancellationEmail(String businessEmail, String businessName, BookingResponse booking) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            ...
            String htmlContent = """
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            <p>To the team at <strong>%s</strong>,</p>
                            <p>A booking with your business, <strong>%s</strong>, has been cancelled. Below are the details of the cancelled appointment:</p>
                            <div class="details">
                                <h3>Cancelled Booking Details</h3>
                                <ul>
                                    <li><strong>Client Name:</strong> %s</li>
     ...
     @Async
    public void sendBookingFinishedEmail(String recipientEmail, String name, BookingResponse booking) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");

            helper.setTo(recipientEmail);
            helper.setSubject("Booking Completed - " + booking.getBusinessName());
            helper.setFrom("yahyaaahamdi8756@gmail.com"); // Replace with your sender email
            ...
            String htmlContent = """
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            <p>Dear <strong>%s</strong>,</p>
                            <p>Your booking with <strong>%s</strong> has been successfully completed. Thank you for choosing us! Below are the details of the completed appointment:</p>
                            <div class="details">
                            ...
                            <p>We hope you had a great experience! Please consider leaving feedback.</p>
                        </div>
                        <div class="footer">
                            <p>Cherit Solutions &copy; 2025 | <a href="https://cheritsolutions.com">Visit our website</a></p>
                        </div>
            ...
            throw new RuntimeException("Failed to send completed booking email", e);
        }
    }

    @Async
    public void sendBusinessBookingFinishedEmail(String businessEmail, String businessName, BookingResponse booking) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            ...
            String htmlContent = """
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            <p>To the team at <strong>%s</strong>,</p>
                            <p>A booking with your business, <strong>%s</strong>, has been marked as completed. Below are the details of the completed appointment:</p>
                            <div class="details">
                                <h3>Completed Booking Details</h3>
                                <ul>
                                    <li><strong>Client Name:</strong> %s</li>
                            ...
                            <p>Please update your records and consider requesting feedback from the client.</p>
                        </div>
                        <div class="footer">
                            <p>Cherit Solutions &copy; 2025 | <a href="https://cheritsolutions.com">Visit our website</a></p>
                        </div>
